...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void loginUser() async {
    ...
    bool ans = await AuthService()
        .loginUser(email: mailController.text, password: pwdController.text);
    setState(() {
      isLoading = false;
    });
    if (!ans)
      showSnackBar("Error Sign In, Checkout Console", context);
    else
